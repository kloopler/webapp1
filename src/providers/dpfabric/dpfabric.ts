...
export class Dpfabric {
  ...
  setupCanvas() {
    var canvas = new fabric.Canvas('canvas'),
      canvasWidth = (<HTMLCanvasElement> document.getElementById('canvas')).width,
      canvasHeight = (<HTMLCanvasElement> document.getElementById('canvas')).height,
      counter = 0,
      rectLeft = 0,
